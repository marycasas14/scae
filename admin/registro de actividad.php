...
if (isset($_POST['subir'])) {
    ...
    $destino = "../admin/archivos/" . $nombre;
            ...
            if(empty($boleta) || empty($conf_boleta) || empty($fecha) || empty($nombre) || empty($apellidos) || empty($edad) || empty($genero) || empty($carrera) || empty($carrera) || empty($semestre) || empty($correo) || empty($telefono) || empty($domicilio) || empty($contacto) || empty($taller)){
            ...
            copy($ruta,$destino);
            $db=new Conect_MySql();
            $sql = "INSERT INTO solicitud(folio,boleta,fecha,nombre,apellidos,edad,genero,carrera,semestre,correo,telefono,domicilio,contacto,taller,documentos) VALUES('NULL','$boleta','$fecha','$nombre_alumno','$apellidos','$edad','$genero','$carrera','$semestre','$correo',$telefono,'$domicilio','$contacto','$taller','$nombre')";
                ...
                <table>
                    <tr>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="apellidos" style="width: 170px"></td>
                    </tr>
