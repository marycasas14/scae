<?php
  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      /*
        ...
        usuario existe r etornara 1 de lo contrario retornara 0
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        if($_SESSION['cargo'] == 1){
          echo '../admin/menu_administrador.html';
        }else if($_SESSION['cargo'] == 2){
          echo '../admin/menu_profesor.html';
        }
    ...
    public function registroUsuario($name, $email, $clave)
    {
      ...
      $verificarnombre = parent::verificarRegistros('select id_profesor from profesor where nombre_p="'.$name.'" ');

     if ($verificarnombre < 1 ) {
       echo 'error_5';
     } else{

      $verificarnombreusuario = parent::verificarRegistros('select id from usuarios where nombre="'.$name.'" ');
