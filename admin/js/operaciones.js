$('#login').click(function(){
  ...
  $.ajax({
    ...
    success: function(res){
      ...
      swal('Error', 'Por favor complete los campos ', 'warning');
      }else if(res == 'error_2'){
  ...
  $.ajax({
    ...
    success: function(res){
      ...
      if(res == 'error_1'){
        ...
        swal('Error', 'Nombre no registrado', 'warning');
      }else if(res == 'error_6'){
        swal('Error', 'Nombre ya registrado', 'warning');
